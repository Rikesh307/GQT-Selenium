/*WAS to nevigate to the gmail application and type email using "CSS LOCATOR" Advance locator substring starts with "tagname[attribute name ^= 'attribute value']".
 * 
 * HTML code for email
 * ------------------------------
...
public class Selenium18 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(3000);
		WebElement email = driver.findElement(By.cssSelector("input[id ^='ident']"));
